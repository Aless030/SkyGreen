    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item">
            <a class="nav-link" href="#workwithus2"> Árboles 3D </a>
          </li>
          <li class="nav-item">
...
`;
      ...
      const popup = new mapboxgl.Popup({
          offset: [20, -70], // Desplazamiento para que aparezca más a la derecha y hacia arriba
          closeButton: false,
          closeOnClick: true
        })
      ...
      // Evento para centrar el mapa en el árbol y mostrar el popup con efecto
      el.addEventListener('click', () => {
        ...
        setTimeout(() => {
          ...
          // Ajustar la posición y escala del popup
          ...
          // Esperar a que se inserte el botón y agregar evento de cierre
          setTimeout(() => {
      ...
      // Abrir formulario cuando se hace clic en "Adoptar árbol"
      ...
      // Cerrar formulario con botón de cerrar
      ...
      // Enviar formulario (aquí puedes añadir lógica para enviar los datos)
